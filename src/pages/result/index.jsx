  ...
  export default function Result() {
    ...
    return (
      <div className="h-screen">
        ...
        <div className="py-2">
        {/* <DashboardFilter/> */}
          <h3 className="text-2xl mb-5" style={{borderBottom: '2px solid', paddingBottom: '10px'}}>Student Result</h3>

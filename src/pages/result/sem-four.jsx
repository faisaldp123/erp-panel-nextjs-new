import {
  ...
  export default function SemFour() {
    const studentInfo = {
    ...
    const results = [
      ...
      {
        subjectCode: "BAGEN402",
        subjectTitle: "Business Communication",
        externalMax: 70,
        externalObtained: 53,
        internalMax: 30,
        internalObtained: 27,
      ...
      {
        subjectCode: "BAGEN403",
        subjectTitle: "Economics-Industrial Development",
        externalMax: 70,
        externalObtained: 49,
        internalMax: 30,
        internalObtained: 20,
      ...
      {
        subjectCode: "BAGEN404",
        subjectTitle: "English Literature- Essay and Short Stories",
        externalMax: 70,
        externalObtained: 39,
        internalMax: 30,
        internalObtained: 19,
      ...
      {
        subjectCode: "BAGEN409",
        subjectTitle: "Maths- IV Advanced Calculus",
        externalMax: 70,
        externalObtained: 46,
        internalMax: 30,
        internalObtained: 22,
